...
namespace SalesManagement.Data.Migrations
{
    ...
    [Migration("20260201042741_addInvoice")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesManagement.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SalesManagement.Models.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("SalesManagement.Models.SaleDetail", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SalesManagement.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SalesManagement.Models.InvoiceItem", b =>
                {
                    b.HasOne("SalesManagement.Models.Invoice", "Invoice")
                        .WithMany("Items")
